...
ALLOWED_LOG_FILES = {
    ...
    "learned_risk_stage_b_pilot_calibration_samples.csv",
    "learned_risk_stage_b_pilot_results.jsonl",
    "learned_risk_stage_b_pilot_results_flat.csv",
    "learned_risk_stage_b_pilot_step_predictions.csv",
    "learned_risk_closedloop_stage_b_pilot_calibration_samples.csv",
    "learned_risk_closedloop_stage_b_pilot_results.jsonl",
    "learned_risk_closedloop_stage_b_pilot_results_flat.csv",
    "learned_risk_closedloop_stage_b_pilot_step_predictions.csv",
    "results.jsonl",
    "results_flat.csv",
